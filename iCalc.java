...
class iCalc{
 public static void main(String args[]){
	  ...
	  System.out.printf("%5s %d %s %s %n","[",o1,"]","Decimal Converter");
	  System.out.printf("%5s %d %s %s %n","[",o2,"]","Binary Converter");
	  System.out.printf("%5s %d %s %s %n","[",o3,"]","Octal Converter");
	  System.out.printf("%5s %d %s %s %n","[",o4,"]","Hexadecimal Converter");
	  System.out.printf("%5s %d %s %s %n","[",o5,"]","Roman Converter");
	  System.out.println();
	  ...
	  o1=1;
	  o2=2;
	  System.out.printf("%5s %d %s %s %n","[",o1,"]","Decimal Number to Roman Number Converter");
	  System.out.printf("%5s %d %s %s %n","[",o2,"]","Binary Number to Decimal Number Converter");
